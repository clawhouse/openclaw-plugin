# Publishing @clawhouse/openclaw-plugin
...
|---|---|---|---|
| `0.2.0` | `v0.2.0` | `latest` | `npm i @clawhouse/openclaw-plugin` |
| `0.2.0-alpha.1` | `v0.2.0-alpha.1` | `alpha` | `npm i @clawhouse/openclaw-plugin@alpha` |
| `0.2.0-beta.1` | `v0.2.0-beta.1` | `beta` | `npm i @clawhouse/openclaw-plugin@beta` |
| `0.2.0-rc.1` | `v0.2.0-rc.1` | `rc` | `npm i @clawhouse/openclaw-plugin@rc` |
